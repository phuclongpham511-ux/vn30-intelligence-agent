...
export default function FundamentalsCard({ data }: { data: Fundamental }) {
  return <section><div className="mb-4 flex flex-wrap items-center justify-between gap-2"><h2>Fundamentals</h2><span className="text-[10px] text-muted-foreground">Annual · {data.period || "Period unavailable"} · {data.source}</span></div>
