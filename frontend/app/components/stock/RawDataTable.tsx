...
export default function RawDataTable({ bars }: { bars: Bar[] }) {
  return <details className="panel overflow-hidden"><summary className="flex items-center gap-2 px-5 py-4 text-xs font-medium"><Table2 size={15} className="text-muted-foreground"/>View raw data<span className="ml-auto text-[10px] text-muted-foreground">{bars.length} daily observations Â· Expand</span></summary>
